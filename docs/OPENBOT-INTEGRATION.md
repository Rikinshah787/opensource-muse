...
## Recommended OpenSource Muse configuration

These are proposed **OpenSource Muse** settings, not upstream environment variables:
...
| OpenSource Muse capability | OpenBot request |
| --- | --- |
