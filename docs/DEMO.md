...
**OpenSource Muse 🪁 — ask it to browse, follow along in chat, and take control when you need to.** The native iPhone recording is framed in a 1920 × 1080 (16:9) canvas, with a cream, blue, and lilac background and captions for sound-off viewing.
...
| Time | Scene |
| --- | --- |
| 0:00–0:04 | Ask OpenSource Muse to explore Hacker News |
...
| 0:31–0:38 | Return to chat and the OpenSource Muse repository |
...
- The open-source repository at [CopilotKit/OpenSource Muse](https://github.com/CopilotKit/OpenSource Muse).
...
A separate recording of the actual desktop web app, placed below the mobile demo in the README. Ask **“Check my emails for the school trip”**, open the school's reminder, then ask **“Research Monterey Bay Aquarium and suggest three exhibits”**. The 1440 × 810 browser capture sits inside a 1920 × 1080 canvas with the same cream, blue, and lilac background and OpenSource Muse 🪁 branding.
...
```sh
xcrun simctl io booted recordVideo --codec=h264 OpenSource Muse-recording.mp4
