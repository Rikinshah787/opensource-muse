...
import { StudioScreen } from "./src/studio";
...
const titles: Partial<Record<Section, { title: string; subtitle: string }>> = {
  ...
  studio: { title: "Studio", subtitle: "Shape prompts, launch notes and reusable project angles." },
            ...
            {busy ? (
              ...
              <Card style={{ width: "100%" }}>
                ...
                <Text style={[s.small, { marginTop: 15 }]}>
                  Local workspaces open without a key. Make sure your OpenSource Muse server is running at{" "}
                  {API_URL}.
                </Text>
              </Card>
            )}
...
function WorkspaceShell({
  ...
  const agentName = data?.identity.name || "OpenSource Muse";
