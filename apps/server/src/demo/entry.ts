...
const workerToken = process.env.DEMO_WORKER_TOKEN ?? "OpenSource Muse-local-demo-worker-token-2026";
const sessionToken = "OpenSource Muse-local-demo-session-token-2026";
...
console.log(
  "OpenSource Muse recording demo: AI Mock scripts the model; browser visits use the real worker.",
);
